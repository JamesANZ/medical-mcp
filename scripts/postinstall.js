...
function createClaudeConfig() {
  try {
    ...
    console.log('🔄 Please restart Claude Desktop to use the medical-mcp server');
    console.log('');
    ...
    console.log('  • search-dental-insurance-codes - Search dental insurance codes');
    ...
    console.log('  "Check for drug interactions between metformin and aspirin"');
